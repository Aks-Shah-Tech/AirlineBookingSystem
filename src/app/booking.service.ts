...
export class BookingService {
  private apiURL = "http://localhost:53600/api";
  ...
  create(booking:Booking): Observable<any> {
    ...
    return this.httpClient.post(this.apiURL + '/bookings/', JSON.stringify(booking), this.httpOptions)
  ...
  update(id:number, booking:Booking): Observable<any> {
    ...
    return this.httpClient.put(this.apiURL + '/bookings/' + id, JSON.stringify(booking), this.httpOptions)
